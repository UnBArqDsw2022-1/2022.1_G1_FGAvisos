...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Antonio Igor Carvalho     | Contribuição na criação de componentes para o front-end, ajuda aos colegas no front-end, pequena contribuição na criação inicial do back-end, contribuição na criação do documento de reutilização, revisão de pull requests | Regular
...
| Mateus Moreira Lima       | |
| Victor Hugo C. Silva      | Contribuição na criação de componentes, páginas e funcionalidades do front-end do projeto| Regular
...
|   09/09    |   0.6     |   Adicionando participação e relato                                 |    Antonio Igor            |        |
|   09/09    |   0.7     |   Adicionando participação e relato                                 |    Victor Hugo           |        |