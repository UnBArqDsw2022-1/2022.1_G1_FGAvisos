...
| Lameque Fernandes Azevedo | Criação do back-end, banco de dados, conteinerização do projeto com Docker, deploy do back-end no Heroku e contribuição na criação de páginas e componentes do front-end. |
