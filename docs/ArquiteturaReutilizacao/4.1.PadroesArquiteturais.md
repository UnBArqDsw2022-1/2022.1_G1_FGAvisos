...
Este documento se aplica ao sistema de lançamento e visualização de avisos __FGAvisos__. Nesse documento poderão ser encontrados os padrões de software, componentes de software, plataformas e frameworks de desenvolvimento, casos de uso e serviços de persistência de dados.
