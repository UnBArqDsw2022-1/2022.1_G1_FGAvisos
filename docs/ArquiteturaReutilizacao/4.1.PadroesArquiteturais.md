...
[FastAPI](https://fastapi.tiangolo.com/): Ferramenta utilizada para criação de serviços REST. Através de endpois, o serviço será capaz de alimentar com dados as necessidades do FrontEnd.

### Banco de Dados 
 
[PostGres](https://www.postgresql.org/docs/): Para persistência dos dados, foi utilizado o PostGres que é um banco de dados que trabalha com o paradígma relacional. A ideia é persistir os dados que o backend transmitir.
...
|Público|A aplicação é voltada para alunos, professores e coordenadores da UnB Gama| 
...
| 05/09 | 0.2    | Adição das visões                                   | Antonio Rangel | --- | 
