...
| UC08 | Buscar avisos | O presente caso de uso descreve o fluxo de atividade que inclui buscar os avisos cadastrados. O sistema deve ser capaz de permitir que o usuário busque os avisos cadastrados. |
...
| 09/09 |  1.0   | Finalizando descrição dos casos de uso | Vitor Diniz | --- | 
