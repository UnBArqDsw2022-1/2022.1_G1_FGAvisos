...
| Léxico      | Noção                              | Impacto                                                                                                             | Sinônimo           | Classificação |
| ----------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------- |
| Criar aviso | Fazer um informativo na aplicação. | Os usuários do tipo professor e coordenador poderam criar aviso, escolher tags para o aviso e selecionar prioridade | Fazer informativo. | Verbo         |
...
| Léxico                             | Noção                                       | Impacto                                                                                                                                                                                                                                                                          | Sinônimo    | Classificação |
| ---------------------------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------- |
| Criar perfil professor/coordenador | O docente irá fazer uma conta na aplicação. | Os usuários do tipo professor/coordenador poderam criar um perfil na aplicação informando seus dados, que seram analisados por um administrador, para que esse possa conceder acesso, após ter acesso concedido poderam usar a aplicação para criar avisos e postar comentários. | Fazer conta | Verbo         |
...
| Léxico  | Noção                                | Impacto                                                                                     | Sinônimo      | Classificação |
| ------- | ------------------------------------ | ------------------------------------------------------------------------------------------- | ------------- | ------------- |
| Eventos | Acontecimento que se passará na FGA. | Eventos que iram ocorrer na FGA e que poderam ser anunciados por coordenadores em um aviso. | Acontecimento | Objeto        |
...
| Léxico  | Noção                                                           | Impacto                                                                                                                                                                                                                                                                                                                       | Sinônimo | Classificação |
| ------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------------- |
| Excluir | Na aplicação será possível apagar comentários, avisos e perfis. | Os usuários do tipo professor, coordenador e administrador poderam excluir avisos, que tenha sido criado pelo seu perfil. Os usuários de todos tipos poderam excluir seus comentários, que tenha sido criado pelo seu perfil. O usuário do tipo administrador poderá excluir contas de outros usuários, caso seja necessário. | Apagar   | Verbo         |
...
| Léxico | Noção              | Impacto                                                                                          | Sinônimo | Classificação |
| ------ | ------------------ | ------------------------------------------------------------------------------------------------ | -------- | ------------- |
| Perfil | Página do usuário. | O perfil é o local onde seram disponibilizadas as informações de um usuário, como nome e e-mail. | Página   | Objeto        |
...
| Léxico     | Noção                                          | Impacto                                                                                                                                                                               | Sinônimo    | Classificação |
| ---------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------- |
| Relevância | Importância de determinado aviso ou comentário | A relevância de um aviso ou comentário, que pode ser determinada por quantidade de curtidas ou prioridade destacada. Serve para facilitar o aluno de achar a informaçaões essenciais. | Importância | Estado        |
...
| Léxico | Noção                                   | Impacto                                                                                                | Sinônimo         | Classificação |
| ------ | --------------------------------------- | ------------------------------------------------------------------------------------------------------ | ---------------- | ------------- |
| Tags   | Rótulo utilizado para filtrar pesquisa. | Tags poderam ser utilizadas para filtrar uma pesquisa, facilitando aluno a achar informação procurada. | Rótulo, etiqueta | Objeto        |
