...
### 1.1 - Debater aspectos e documentar com mapas mentais
...
### 1.2 - Modelar usando desenho (Ex: Rich Picture)
...
### 1.3 - Escolher o melhor modelo dentre os feitos pelos membros
...
## 4 - Estimativas de Custo e Esforços
...
### 5.2 - Abaixo temos uma tabela com os principais riscos identificados ao decorrer do projeto.
...
| 25/06/2022 | 0.4    | Revisão e complemento do gerenciamento de riscos  | Davi Marinho      |   |