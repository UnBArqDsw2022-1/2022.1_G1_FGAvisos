...
Uma user story está associada a uma feature, porém, traz mais especifica e possui mais detalhes de uma determinada funcionalidade. Além disto, são escritas através da perspectiva de um usuário.
...
Através dos itens levantados nas diversas granularidades do projeto, foi possível relacionar todos os níveis de abstração e centralizar tudo em uma tabela só, trazendo uma visão mais ampla do backlog.
...
|:----------:|:-----:|:--------------------------------------------------------------------------------------:|:-----------------:|:-------:|
| 09/07/2022 |  0.1  | Escopo do backlog                                                                      | Lameque Fernandes | xxxxxxx |
| 10/07/2022 |  0.2  | Adição da granularidade com épicos, features e user storys                             | Lameque Fernandes | xxxxxxx |
| 12/07/2022 |  0.3  | Adição de rastrabilidade nas features                                                  | Lameque Fernandes | xxxxxxx |
| 14/07/2022 |  1.0  | Adição de backlog priorizado, atualização na introdução e explicação de alguns tópicos | Lameque Fernandes | Antonio Igor |
