...
| Hugo Rocha                | |
| João Paulo Coelho         | Participei dos desenvolvvimentos em grupo e também de alguns documentos em pareamento, mas sinto que não consegui ajudar tanto quanto nas últimas entregas, por outro lado dessa vez consegui revisar quase todos documentos com mais calma, o que pretendo manter pois me passou um conhecimento mais geral do projeto. |
| Lameque Fernandes Azevedo | |
| Mateus Moreira Lima       | |
